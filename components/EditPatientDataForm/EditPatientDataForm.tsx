...
const EditPatientDataForm: FunctionComponent = () => {
  ...
  return (
    <form onSubmit={form.onSubmit(handleSubmit, handleSubmitErrors)} noValidate>
      <Grid
        p="lg"
        styles={{
          root: {
      ...
      >
        ...
        {Exercises.List.map(({ value, label }: Exercise) => (
          <SectionItem key={value}>
            <Select
              classNames={classNames}
              clearable
              label={label}
